  ...
  return (
    <Card className="p-6 bg-card border-0 shadow-sm">
      <div className="flex items-start space-x-4">
        ...
        <div className="w-16 h-16 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#2b3da1' }}>
          <Building2 className="w-8 h-8 text-white" />
        </div>
        
        <div className="flex-1">
          <h3 className="text-lg font-semibold text-foreground">{name}</h3>
          <p className="text-sm font-medium" style={{ color: '#2b3da1' }}>{period}</p>
